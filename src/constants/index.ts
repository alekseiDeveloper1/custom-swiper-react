...
export const DEFAULT_SLIDES = [
  ...
  { id: '4', title: 'SECURITY', stage: ['2010', '2015'], subSlides: [
    ...
    {title: 2010, description: 'Clean folder structure based on industry best practices.'},
    {title: 2015, description: 'Clean folder structure based on industry best practices.'}
  ]},
  { id: '5', title: 'ANALYTICS', stage: ['1100', '2101'], subSlides: [
    {title: 2100, description: 'Clean folder structure based on industry best practices.'},
    {title: 2201, description: 'Clean folder structure based on industry best practices.'},
    {title: 2302, description: 'Clean folder structure based on industry best practices.'}
  ] },
  { id: '6', title: 'AUTOMATION', stage: ['2987', '2988'], subSlides: [
    {title: 2987, description: 'Clean folder structure based on industry best practices.'},
    {title: 2987, description: 'Clean folder structure based on industry best practices.'},
    {title: 2988, description: 'Clean folder structure based on industry best practices.'}
  ] },
];
